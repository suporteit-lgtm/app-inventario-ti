...
export const TERMOS: TermoEnvio[] = [
  {
    ...
    arquivo: 'termo-responsabilidade-carla-nunes.pdf',
    status: 'assinado',
    driveUrl: 'https://drive.google.com/file/d/1AbCdEfGhIjKlMnOpQrStUvWxYz012345/view',
  ...
  },
  {
    ...
    unidade: 'Belo Horizonte',
    arquivo: 'termo-responsabilidade-juliana-prado.pdf',
    status: 'enviado',
    clicksignUrl: 'https://app.clicksign.com/documentos/demo-2',
  ...
  },
  {
    ...
    unidade: 'São Paulo',
    arquivo: 'termo-comodato-rafael-souza.pdf',
    status: 'recusado',
    clicksignUrl: 'https://app.clicksign.com/documentos/demo-3',
